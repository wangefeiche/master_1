            ...
            for j in range(segment_count):
                if S_time_interval[-1-j] != 0:
                    if S_send_data_size[-1-j]!= 0 and segment_count <= 10:
                        th_10 += S_send_data_size[-1-j]/S_time_interval[-1-j]/1000000  
                    elif  S_send_data_size[-1-j]!= 0 and segment_count <= 25:
                        th_25 += S_send_data_size[-1-j]/S_time_interval[-1-j]/1000000
                    else:
                        th_50 += S_send_data_size[-1-j]/S_time_interval[-1-j]/1000000  
